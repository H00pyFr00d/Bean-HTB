...
function App() {
  ...
  const Footer = () => {
    return ( <p style={{'float': 'right', 'paddingTop': '0.5%'}}> Data sourced from <a href = "https://data.edinburghcouncilmaps.info/datasets/ddb5fcb791634729b4b4d3d1e5b8aa05/explore"> Edinburgh City Council </a> , May 2021. </p>
    )
  }
